...
export default function BasicTable() {
  ...
  const handleSubmitEdit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    await updateStatusUser({ status: status, idUser: idModal }).catch(
      (error) => {
        // Handle the error
        console.error(error);
      }
    ...
    getAllUsers().then((data) => setPerson(data));
  };
                ...
                .map((person) => (
                  <TableRow key={person.userName}>
                    ...
                    <TableCell align="center">
                      <Button
                        onClick={() =>
                          handleOpenModalEdit(person.iduser, person.cpf)
                        }
                      >
                        <ModeEditIcon />
                      </Button>
                    ...
                    <TableCell align="center">
                      <Button
                        onClick={() =>
                          navigate(
                            `/home/user/point/history/${person.iduser}`,
                            {
                              state: { topicId: person.iduser },
                            }
                          )
                        }
                      >
